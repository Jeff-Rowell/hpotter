...
type TelnetLogParser struct {
	service          types.Service
	credentialRegex  *regexp.Regexp
	sessionDataRegex *regexp.Regexp
}

func NewTelnetLogParser(service types.Service) *TelnetLogParser {
	parser := &TelnetLogParser{
		service:          service,
...
func (p *TelnetLogParser) ParseCredentials(allLogData string) *database.Credentials {
...
func (p *TelnetLogParser) ParseSessionData(allLogData string) *database.Data {
